...
// Remove or comment out the middleware auth group for tasks
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('tasks/{task}/edit', [TaskController::class, 'edit'])->name('tasks.edit')->middleware('can:update,task');
...
Route::get('/users', [UserController::class, 'index'])->name('navUsers');
