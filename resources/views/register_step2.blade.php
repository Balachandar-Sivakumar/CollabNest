  ...
  <div class="relative z-10 p-4 max-w-4xl w-full shadow-lg overflow-hidden">
    ...
    <div class="relative z-10 bg-white flex flex-col md:flex-row rounded-[30px]">
      ...
      <div class="flex-1 bg-[#f0f3ff] rounded-[30px] md:w-[50%] p-10 flex flex-col items-center justify-center">
        <img alt="Illustration" class="mb-6 max-w-[240px] w-full" height="200"
             src="https://img.freepik.com/free-vector/personal-site-concept-illustration_114360-2577.jpg"
             width="240"/>
      ...
      <div class="w-full md:w-[50%] p-10">
        ...
        <form method="POST" action="/step_two" id="detailsForm">
          @csrf
          ...
          <div class="mt-6">
            ...
            <select name="availability" class="w-full border border-gray-300 rounded px-3 py-2 mb-2 text-sm text-black focus:outline-none focus:ring-1 focus:ring-cyan-400">
...
<!-- Simple JS Validation (Inline Error Display) -->
<script>
  document.getElementById('detailsForm').addEventListener('submit', function (e) {
    ...
    if (!profession) {
      error = 'Please enter at least one profession.';
    } else if (!skills) {
