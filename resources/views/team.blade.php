...
<body class="bg-[#f8fafc] text-gray-900 min-h-screen flex">
  ...
  <a href="{{ route('team') }}" class="flex items-center space-x-2 bg-indigo-100 rounded-md py-2 px-3 text-indigo-700">
  ...
  <a href="{{ route('tasks') }}" class="flex items-center space-x-2 py-2 px-3 hover:bg-gray-100 rounded-md">
  ...
  <a href="{{ route('messages') }}" class="flex items-center space-x-2 py-2 px-3 hover:bg-gray-100 rounded-md relative">
